...
upper_location = Label(upperframe, text = " Location: " + str(city) + "        " + "Temp: " + str(temp) +" " +".C", font=("courier",23),bg='DarkSeaGreen1',width=500,anchor=W,wraplength=685)



frame1 = Frame(root)
frame1.pack()
bottomframe = Frame(root,highlightbackground="black",highlightthickness=2,bg='DarkSeaGreen1')

bottom_location = Label(bottomframe, text = " QOTD: " + str(text), font=("courier",23),bg='DarkSeaGreen1',width=500,anchor=W,wraplength=685)
